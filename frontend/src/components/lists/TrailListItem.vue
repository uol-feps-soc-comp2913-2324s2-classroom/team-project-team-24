...
<template>
    <tr class="tableRow p-1 my-5" @click="viewTrail">
        <td class="tdItem tdItemCheckbox ps-4">
            <input
                type="checkbox"
                :value="trail.id"
                v-model="checked"
        ...
        <td class="tdItem">
            <p>{{ trail.exercise_type }}</p>
        </td>
        <td class="tdItem tdItemButtons pe-4">
            <div>
                <button
                    class="imageButton zoom-button"
                    :style="buttonStyle"
                    v-if="isSelected"
                    @click.stop="zoomToTrail"
                >
                    <span
                        ><img src="../../assets/Smock_Location_18_N.svg"
                    /></span>
                </button>
                <button
                    class="imageButton mx-3"
                    :style="buttonStyle"
                    @click.stop="downloadTrail"
                >
                    <span
                        ><img src="../../assets/Smock_Download_18_N.svg"
                    /></span>
                </button>
                <button
                    class="imageButton"
                    :style="buttonStyle"
                    @click.stop="deleteTrail"
                >
                    <img src="../../assets/Smock_Delete_18_N.svg" />
                </button>
            </div>
        </td>
    </tr>
