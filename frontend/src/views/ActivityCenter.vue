<template>
    <div class="activityCenterPageContainer">
        <div
            class="map-and-stats-container d-flex flex-column"
            id="mapAndStatsContainer"
        >
            ...
            <div
                class="d-flex flex-row align-items-center justify-content-between px-4 py-2"
                id="overAllTrailStatsComponent"
            >
                <h2>My trails</h2>
...
export default {
    ...
    methods: {
        ...
        getMapDimensions() {
            const mapAndStatsContainer = document.getElementById(
                'mapAndStatsContainer'
            )
            const overAllTrailStatsComponent = document.getElementById(
                'overAllTrailStatsComponent'
            )
            if (mapAndStatsContainer && overAllTrailStatsComponent) {
                this.mapViewHeight =
                    mapAndStatsContainer.getBoundingClientRect().height -
                    overAllTrailStatsComponent.getBoundingClientRect().height
                this.mapViewWidth =
                    mapAndStatsContainer.getBoundingClientRect().width
            } else {
