...
Revision ID: 28b156fce252
Revises: 
Create Date: 2024-03-01 11:31:46.980687
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('fk_user_1', sa.Integer(), nullable=True),
    sa.Column('fk_user_2', sa.Integer(), nullable=True),
